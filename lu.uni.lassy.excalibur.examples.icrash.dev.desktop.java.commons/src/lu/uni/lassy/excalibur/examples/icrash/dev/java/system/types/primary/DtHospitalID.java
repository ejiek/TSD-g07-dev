...
/**
 * The Class DtHospitalID, which holds a datatype of the hospital ID.
 */
public class DtHospitalID extends DtString implements JIntIs{
		 ...
		 */
		public DtHospitalID(PtString s) {
			super(s);
		}
		...
		public PtString getExpectedDataStructure(){
			return new PtString("Expected strucutre of the hospital ID is to have a minimum length greater than " + _minLength + " and a maximum length of " + _maxLength); 
		}
}

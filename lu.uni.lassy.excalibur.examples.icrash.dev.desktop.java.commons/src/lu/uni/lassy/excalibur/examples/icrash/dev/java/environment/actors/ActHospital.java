...
/**
 * The Interface ActHospital.
 */
public interface ActHospital extends java.rmi.Remote, Serializable, JIntIsActor {
	 ...
	 * @throws NotBoundException Thrown if the server is not bound correctly in RMI settings
	 */
	public void addListener(ActProxyHospital aActProxyAuthenticated) throws RemoteException, NotBoundException;
	 ...
	 * @throws NotBoundException Thrown if the server is not bound correctly in RMI settings
	 */
	public void removeListener(ActProxyHospital aActProxyAuthenticated) throws RemoteException, NotBoundException;
}

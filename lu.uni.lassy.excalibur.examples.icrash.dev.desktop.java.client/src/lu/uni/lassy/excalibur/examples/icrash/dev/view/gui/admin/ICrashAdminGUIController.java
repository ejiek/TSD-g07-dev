...
public class ICrashAdminGUIController extends AbstractAuthGUIController {
	...
	*/
    ...
    /** The button that shows the controls for adding a hospital */ //_t7
    @FXML
    private Button bttnBottomAdminCoordinatorAddAHospital;

    /** The button that shows the controls for deleting a hospital */ //_t7
    @FXML
    private Button bttnBottomAdminCoordinatorDeleteAHospital;
    ...
    /**
     * The button event that will show the controls for adding a hospital
     *
     * @param event The event type thrown, we do not need this, but it must be specified
     */
    @FXML
    void bttnBottomAdminCoordinatorAddAHospital_OnClick(ActionEvent event) { //_t7
    	showHospitalScreen(TypeOfEdit.Add);
    }

    /**
     * The button event that will show the controls for deleting a hospital
     *
     * @param event The event type thrown, we do not need this, but it must be specified
     */
    @FXML
    void bttnBottomAdminCoordinatorDeleteAHospital_OnClick(ActionEvent event) { //_t7
    	showHospitalScreen(TypeOfEdit.Delete);
    }
    /**
